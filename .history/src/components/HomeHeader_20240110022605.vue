            ...
            <ul class="multi-sub-menu">
              <li class="sub-menu-description">
                ...
                <p>
                  ...
                  user-friendly, responsive web applications. Demonstrated success in
                  collaborative projects and personal initiatives, eager to
                  contribute to cutting-edge frontend development.
                </p>
              </li>
              <li class="has-submenu">
              ...
              <li class="has-submenu">
                ...
                <ul>
                  ...
                  <li>
                    <a href="/"
                      >client interaction capabilities</a
                    >
                  </li>
                  <li>
                    <a href="/"
          ...
          <li class="has-submenu">
            ...
            <ul>
              <li class="sub-menu-description">
                ...
                <p>
                  - Led the development of the vivo invoice center project, implementing advanced frontend technologies and optimizing user experience.
                </p>
                <p>
                  - Collaborated with international teams, enhancing web applications with features like multi-language support and accessibility options.
                  - Conducted technical training for colleagues, enhancing team capabilities in frontend development technologies
                </p>
                <p>
                  - Conducted technical training for colleagues, enhancing team capabilities in frontend development technologies
                </p>
              </li>
              <li class="sub-menu-description" style="position: relative; padding-right: 80px;">
                <h2>Achievements</h2>
                <p>
                  - User Base Expansion: Significantly contributed to the enhancement of the vivo merchant management system, resulting in an increase of collaborating merchants from under 100 to over 3000 in 1 year
                </p>
                <p>
                  - Patent Contribution: Key player in the vivo merchant team, instrumental in securing the Chinese Internet Project Patent, demonstrating innovative solution delivery in a competitive tech environment.
                </p>
              </li>
            </ul>
          </li>
