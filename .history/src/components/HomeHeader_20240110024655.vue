      ...
      <nav class="">
        <ul>
          ...
          <li class="has-submenu">
            ...
            <ul>
              <li class="sub-menu-description" style="padding-right: 80px; width: 400px">
                <h2>Vue3 + Typescript</h2>
                <p>
                  Travel Website App: Developed a dynamic travel website app,
                  emphasizing responsive design and user engagement.
                </p>
                <br />
                <p>
                  Mimicked Zhihu Column, demonstrating advanced application development skills and understanding of enterprise needs.
                </p>
                <br />
                <p>
