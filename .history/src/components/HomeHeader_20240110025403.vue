      ...
      <nav class="">
        <ul>
            ...
            <ul class="multi-sub-menu">
              <li class="sub-menu-description">
                ...
                <p>
                  ...
                  software engineering, skilled in designing and implementing
                  user-friendly, responsive web applications. Demonstrated
                  success in collaborative projects and personal initiatives,
                  eager to contribute to cutting-edge frontend development.
                </p>
              </li>
              <li class="has-submenu">
          ...
          <li class="has-submenu">
            ...
            <ul>
              <li class="sub-menu-description" style="padding-right: 80px; width: 600px">
                <h2>Vue3 + Typescript</h2>
                <p>
                  Vue3 + Typescript Travel Website App: a dynamic travel website app,
                  emphasizing responsive design and user engagement.
                </p>
                <br />
                <p>
                  Mimicked "Zhihu" Column: an advanced application development skills and understanding of enterprise needs.
                </p>
                <br />
                <p>
                  "Old Island" Full-Stack Web Application, a scalable application, mastering both server-side and client-side development.
                </p>
                <br />
                <p>
                  Neural Network Model for Computational Fact-checking: Pioneered a machine learning model for data analysis, showcasing innovative problem-solving.
                </p>
              </li>
              <li></li>
            </ul>
          ...
          <li class="has-submenu">
            <a href="https://www.overwolf.com/about-overwolf/">Others</a>
            <ul>
              <li class="sub-menu-description">
                <h2>Status</h2>
                <p>
          ...
          <li><a href="https://www.overwolf.com/careers/">Uk</a></li>
