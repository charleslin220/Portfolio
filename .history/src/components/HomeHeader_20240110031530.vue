    ...
    <div class="header-inner">
      ...
      <nav class="">
        <ul>
          <li class="has-submenu">
            ...
            <ul class="multi-sub-menu">
              <li class="sub-menu-description">
                <h2>Personal Info</h2>
                <p>
                  Innovative Frontend Developer with a robust background in
                  software engineering
                </p>
                <br />
                <p>
                  Skilled in designing and implementing user-friendly,
                  responsive web applications. Demonstrated success in
                  collaborative projects and personal initiatives
                </p>
                <br />
                <p>Eager to contribute to cutting-edge frontend development.</p>
              </li>
              <li class="has-submenu">
              ...
              <li class="has-submenu">
                ...
                <ul>
                  ...
                  <li>
                    <a href="#">Full UK driver license</a>
                  </li>
                </ul>
              </li>
              ...
              <li class="has-submenu">
                ...
                <ul>
                  ...
                  <li>
                    <a href="#">Details matter</a>
                  </li>
                  <li>
                    <a href="#">Client interaction capabilities</a>
                  </li>
                  <li>
                  ...
                  <li>
                    <a href="#">Strong willing to learn</a>
                  </li>
                  <li>
                    <a href="#">Tons of hobbies</a>
                  </li>
                </ul>
              </li>
            </ul>
          ...
          <li class="has-submenu">
            ...
            <ul>
              <li
                ...
                style="padding-right: 80px; width: 400px"
              >
                <h2><a href="https://www.vivo.com.cn/" target="_blank">Vivo</a></h2>
                <p>07/2021-06/2023</p>
                <p>
                  - Led the development of the vivo invoice center project,
                  implementing advanced frontend technologies and optimizing
                  user experience.
                </p>
                <br />
                <p>
                  - Collaborated with international teams, enhancing web
                  applications with features like multi-language support and
                  accessibility options. - Conducted technical training for
                  colleagues, enhancing team capabilities in frontend
                  development technologies
                </p>
                <br />
                <p>
                  - Conducted technical training for colleagues, enhancing team
                  capabilities in frontend development technologies
                </p>
              </li>
              <li
                class="sub-menu-description"
                style="position: relative; padding-right: 80px; width: 400px"
              >
                <h2>Achievements</h2>
                <p>
                  - User Base Expansion: Significantly contributed to the
                  enhancement of the vivo merchant management system, resulting
                  in an increase of collaborating merchants from under 100 to
                  over 3000 in 1 year
                </p>
                <br />
                <p>
                  - Patent Contribution: Key player in the vivo merchant team,
                  instrumental in securing the Chinese Internet Project Patent,
                  demonstrating innovative solution delivery in a competitive
                  tech environment.
                </p>
              </li>
            </ul>
          ...
          <li class="has-submenu">
            <a href="#" onclick="return false;">Education</a>
            <ul>
              <li class="sub-menu-description">
                ...
                <br />
                <h2>Xi’an Jiaotong University</h2>
                <p>2014 - 2018</p>
                <p>Bachelor of Engineering in Automation</p>
                <br />
                <h2>Honors Youth Program</h2>
                <p>Special Class for the Gifted Young in China</p>
              </li>
              <li></li>
            </ul>
          </li>
          <li class="has-submenu">
            ...
            <ul>
              <li
                class="sub-menu-description"
                style="padding-right: 80px; width: 600px"
              >
                <h2><a href="https://github.com/charleslin220?tab=repositories" target="_blank">Personal Projects</a></h2>
                <p>
                  Vue3 + Typescript Travel Website App: a dynamic travel website
                  app, emphasizing responsive design and user engagement.
                </p>
                <br />
                <p>
                  Mimicked "Zhihu" Column: an advanced application development
                  skills and understanding of enterprise needs.
                </p>
                <br />
                <p>
                  "Old Island" Full-Stack Web Application, a scalable
                  application, mastering both server-side and client-side
                  development.
                </p>
                <br />
                <p>
                  Neural Network Model for Computational Fact-checking:
                  Pioneered a machine learning model for data analysis,
          ...
          <li class="has-submenu">
            ...
            <ul>
              <li class="sub-menu-description">
                <h2>Status</h2>
                <p>Ready to work immediately</p>
                <br />
                <p>22 Studio & Game development</p>
                <br />
                <p>
                  <a href="https://music.163.com/#/mv?id=14635731" target="_blank">Musician</a>
                </p>
                <br />
                <p>To be adding</p>
              </li>
